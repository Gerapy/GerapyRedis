...
class Scheduler(object):
    ...
    SCHEDULER_PRE_ENQUEUE_ALL_START_REQUESTS: bool
        Scheduler pre-enqueue all start requests to queue
    """
    
    def __init__(self, server,
                 persist=False,
                 flush_on_start=False,
                 pre_enqueue_all_start_requests=True,
        ...
        pre_enqueue_all_start_requests: bool
            Whether to pre-enqueue all start requests
        queue_key : str
            Requests queue key.
        queue_cls : str
    ...
    def from_settings(cls, settings):
        kwargs = {
            ...
            'pre_enqueue_all_start_requests': settings.getbool('SCHEDULER_PRE_ENQUEUE_ALL_START_REQUESTS',
                                                               defaults.SCHEDULER_PRE_ENQUEUE_ALL_START_REQUESTS),
        }
